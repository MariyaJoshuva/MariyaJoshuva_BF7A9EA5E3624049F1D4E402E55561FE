'''Implement a class called BankAccount that represents a bacnk account. The class should have private
...
account = BankAccount(account_number="123456789", account_holder_name="Roshan", initial_balance=5000.0)
